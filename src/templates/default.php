...
<footer style="background-color: white; z-index: 1; position: relative; display: flex; align-items: center; justify-content: center; flex-direction: column; box-shadow: -1px -1px 1px rgba(0,0,0,0.3)" class="py-3">
  <div style="display: flex; align-items: center; justify-content: center;">
    <img src="/assets/img/logo-footer-biblioteca.png" alt="Logo Biblioteca" width="65px" style="margin-right: 20px;">
    <div class="mb-4">
      <img src="https://fundacaobutantan.org.br/assets/img/logos/ib-fundacao-black.png" alt="Logo Instituto Butantan" width="300px" style="margin-right: 20px;">
