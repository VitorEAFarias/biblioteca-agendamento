  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="d-flex align-items-center justify-content-between">
        <h1 style="color: #0f4192">Usuários</h1>
        <a href="/users/create" class="btn btn-cadastro"><i class="fas fa-pencil-alt"></i> Cadastrar</a>
      </div>
      <hr style="margin-bottom: 0 !important">
      <table class="col-md-12 ls-table" border="0">
        <tr>
          <th width="10%" style="color: #0f4192">CÓDIGO</th>
          <th width="30%" style="color: #0f4192">NOME</th>
          <th width="30%" style="color: #0f4192">EMAIL</th>
          <th width="20%" style="color: #0f4192">FUNÇÃO</th>
          <th width="10%"></th>
        </tr>
                ...
                <?php if ($item['status'] == 1) : ?>
                  <div data-ls-module="dropdown" class="ls-dropdown">
                    ...
                    <ul class="ls-dropdown-nav">
                      <li><a href="<?php echo '/users/edit/' . $item['id'] ?>">Editar</a></li>
                      <li><a href="<?php echo '/users/status/' . $item['id'] . '/0'; ?>">Desativar</a></li>
                    </ul>
                  </div>
                <?php endif ?>

                <?php if ($item['status'] == 0) : ?>
                  <a href="<?php echo '/users/status/' . $item['id'] . '/1'; ?>" class="ls-btn-danger ls-ico-plus">Ativar</a>
                <?php endif ?>
